...
const Playbook = async (clientURL, callback) => {
...
const GetWebpageMarkdown = async (url) => {
...
const GetNews = async () => {
    ...
    await GetChatGPTReply(["What is the company/product's name? Format the answer with just the name and no additional text."], async (name) => {
