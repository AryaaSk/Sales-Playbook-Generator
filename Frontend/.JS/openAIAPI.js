...
let CONTEXT = []; //global context object, which can be edited throughout the app; acts as a centralisd store of the conversations
const GetChatGPTReply = async (prompts, callback, stream, context) => {
